...
if [[ $sysOS == "Darwin" ]]
then
  cp $PWD/SVF/Release-build/lib/libSvf.a libSvf_mac.a
  cp $PWD/SVF/Release-build/lib/CUDD/libCudd.a libCudd_mac.a
...
then
  cp $PWD/SVF/Release-build/lib/libSvf.a libSvf_ubuntu.a
  cp $PWD/SVF/Release-build/lib/CUDD/libCudd.a libCudd_ubuntu.a
